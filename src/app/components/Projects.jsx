...
const projects = [
  {
    ...
    description: "A student collaboration platform with notes sharing, events, and community features.",
    image: "https://images.unsplash.com/photo-1496181133206-80ce9b88a853?auto=format&fit=crop&w=1080&q=80",
    tags: [
      "React",
      "Firebase",
      "Tailwind CSS"
    ...
    category: "Full Stack",
    github: "https://github.com/sandhir-ishita",
    demo: "https://example.com"
  },
  {
    title: "Task Management App",
    description: "A collaborative task management application with real-time updates and progress tracking.",
    image: "https://images.unsplash.com/photo-1480694313141-fce5e697ee25?auto=format&fit=crop&w=1080&q=80",
    tags: [
      "React",
      "Tailwind CSS",
      "REST API"
  ...
  },
  {
    ...
    description: "A responsive weather dashboard with forecasts and live weather updates.",
    image: "https://images.unsplash.com/photo-1658806277165-af0b60eb6733?auto=format&fit=crop&w=1080&q=80",
    tags: [
      "React",
      "API Integration",
      "Chart.js"
...
function Projects() {
  ...
  return <section
    id="projects"
    className="relative overflow-hidden py-20 px-4 sm:px-6 lg:px-8 bg-secondary/30"
  >
      <motion.div
  ...
  >
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-3">
            {marketTags.map((tag, index) => <motion.span
    key={tag}
  ...
  >
    ...
    className={`px-6 py-2 rounded-full text-sm transition-all ${selectedCategory === category ? "bg-gradient-to-r from-[#12304a] to-[#d7b46a] text-white shadow-lg" : "bg-secondary text-secondary-foreground hover:bg-accent"}`}
